...
export const NEW_REVIEW_BLOG_REQUEST = "NEW_REVIEW_BLOG_REQUEST";
export const NEW_REVIEW_BLOG_SUCCESS = "NEW_REVIEW_BLOG_SUCCESS";
export const NEW_REVIEW_BLOG_RESET = "NEW_REVIEW_BLOG_RESET";
export const NEW_REVIEW_BLOG_FAIL = "NEW_REVIEW_BLOG_FAIL";

export const ALL_REVIEW_BLOG_REQUEST = "ALL_REVIEW_BLOG_REQUEST";
export const ALL_REVIEW_BLOG_SUCCESS = "ALL_REVIEW_BLOG_SUCCESS";
export const ALL_REVIEW_BLOG_FAIL = "ALL_REVIEW_BLOG_FAIL";

export const DELETE_REVIEW_BLOG_REQUEST = "DELETE_REVIEW_BLOG_REQUEST";
export const DELETE_REVIEW_BLOG_SUCCESS = "DELETE_REVIEW_BLOG_SUCCESS";
export const DELETE_REVIEW_BLOG_RESET = "DELETE_REVIEW_BLOG_RESET";
