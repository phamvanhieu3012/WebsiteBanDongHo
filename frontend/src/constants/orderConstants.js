...
export const ALL_ORDERS_STATUS_REQUEST = "ALL_ORDERS_STATUS_REQUEST";
export const ALL_ORDERS_STATUS_SUCCESS = "ALL_ORDERS_STATUS_SUCCESS";
export const ALL_ORDERS_STATUS_FAIL = "ALL_ORDERS_STATUS_FAIL";

export const ALL_ORDERS_DATE_REQUEST = "ALL_ORDERS_DATE_REQUEST";
export const ALL_ORDERS_DATE_SUCCESS = "ALL_ORDERS_DATE_SUCCESS";
export const ALL_ORDERS_DATE_FAIL = "ALL_ORDERS_DATE_FAIL";
